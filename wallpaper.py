...
def Rand_color():
    ...
    Color.append((25, 202, 173))
    Color.append((140, 199, 181))
    Color.append((214, 213, 183))
    Color.append((254, 67, 101))
    Color.append((20, 68, 106))
    Color.append((3, 38, 58))
    Color.append((29, 191, 150))
